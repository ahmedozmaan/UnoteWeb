...
<html>
    ...
    <body>
        <div class="header">
            <label class="logo">UNIVERSITY NOTE</label>
            <h2>SIMPLE WAY FOR NOTICE</h2>
            <h2 class="small">Sending push notifications using Android, PHP & MySQL</h2>
        </div>
        <div class="container_body">
            <div class="topics">
                <h2 class="heading">Download & Install the UNOTE apk</h2>
                Download & Install the Google Cloud Messaging <a href="#">apk</a> before trying the demos. <br/><br/>You can manage send recieve messages 
                using.
            </div>
                        ...
                        <ul id="topics">
                            ...
                            foreach ($chatrooms as $key => $chatroom) {
                                ...
                                <li id="<?= $chatroom['chat_room_id'] ?>" class="<?= $cls ?>">
                                    ...
                                    <span><?= $chatroom['chat_room_id'] ?></span>
                                </li>
                                <?php
                            }
                            ?>
